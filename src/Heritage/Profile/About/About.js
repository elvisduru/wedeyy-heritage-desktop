    ...
    <div className={styles.About}>
      ...
      <div className={styles.album}>
        ...
        <div className={styles.Memories}>
          ...
          <SimpleBar style={{ width: '100%', height: '240px', display: 'flex' }}>
            <figure>
              <img src="http://i.pravatar.cc/305" alt="" />
            </figure>
            <figure>
              <img src="http://i.pravatar.cc/306" alt="" />
            </figure>
            <figure>
              <img src="http://i.pravatar.cc/307" alt="" />
            </figure>
            <figure>
              <img src="http://i.pravatar.cc/308" alt="" />
            </figure>
            <figure>
              <img src="http://i.pravatar.cc/309" alt="" />
            </figure>
            <figure>
              <img src="http://i.pravatar.cc/310" alt="" />
            </figure>
          </SimpleBar>
        </div>
      </div>
      <div className={styles.LifeEvents}>
        ...
        <div className={styles.events}>
          <SimpleBar style={{ width: '100%', height: '250px', display: 'flex' }}>
            <div>
